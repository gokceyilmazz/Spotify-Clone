...
public class Kaydol extends javax.swing.JFrame {
    ...
    public Kaydol() {
        ...
        jButton2.setIcon(new ImageIcon ("src\\ok.png"));
        ...
        try {
            while(rs.next()){
               ...
               jComboBox2.addItem(rs.getString("ulkeAdi"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String abonelikTuru= jComboBox1.getSelectedItem().toString();
        String ulke= jComboBox2.getSelectedItem().toString();
        
        if(abonelikTuru.equals("Normal")){
        baglanti.kullaniciEkle(kullaniciAdi, email, sifre, abonelikTuru, ulke);
        JOptionPane.showMessageDialog(rootPane, "Kaydınız alındı giriş yapabilirsiniz");
        
        }
        else  if(abonelikTuru.equals("Premium")){
            int selectedOption = JOptionPane.showConfirmDialog(null, 
            "Premium seçeneğini seçtiniz ödeme yapmak istiyor musunuz", 
            "Ödeme Ekranı", 
           JOptionPane.YES_NO_OPTION); 
           if (selectedOption == JOptionPane.YES_OPTION) {
              baglanti.kullaniciEkle(kullaniciAdi, email, sifre, abonelikTuru, ulke);
              JOptionPane.showMessageDialog(rootPane, "Ödemeniz alındı ve kaydınız gerçekleştirildi.Giriş yapabilirsiniz");
           }
           else if (selectedOption == JOptionPane.NO_OPTION) {
               JOptionPane.showMessageDialog(rootPane, "Premium seçenek için ödeme yapmanız gerekmektedir,kaydınız gerçekleşmedi");
           }
        }
